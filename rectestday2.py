...
if __name__ == '__main__':
    ...
    for current_trial in procedural_file_list:
        ...
        elif current_trial[1] == 'RecTest' and session_flag == 1:
            break
        else:
            instruction_counter = 0
            start_index += 1
    ...
    for current_trial in procedural_file_list[start_index:]:
        ...
        if current_trial[1] == 'instruct':
            ...
            paintings.rec_test_trial(window, mouse, current_trial, experiment_clock, context_list)
            end_flag = 1
