...
if __name__ == '__main__':
    ...
    context_list = paintings.get_context_list(procedural_file_list)

    instruction_counter = 0
    start_index = 0
    session_flag = 0
    for current_trial in procedural_file_list:
        if current_trial[0] == 'Session2':
            session_flag = 1
        ...
        elif current_trial[1] == 'GenRecTest' and session_flag == 1:
            break
        else:
            instruction_counter = 0
            start_index += 1
    ...
    for current_trial in procedural_file_list[start_index:]:
        ...
        if current_trial[1] == 'instruct':
            ...
            paintings.genrec_test_trial(window, mouse, current_trial, experiment_clock, artists, buttons)
            end_flag = 1
